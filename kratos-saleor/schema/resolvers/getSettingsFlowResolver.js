...
const getData = ({sessionToken}) => {
    return new Promise((resolve, reject) => {
        checkSessionToken(resolve, reject, sessionToken);
    });
}

function checkSessionToken(resolve, reject, sessionToken){
    pgKratosQueries.getSessionByToken([sessionToken], result => {
        ...
        createSettingsFlow(resolve, reject, identityId);
    });
}

function createSettingsFlow(resolve, reject, identityId){
    ...
    pgKratosQueries.createSettingsFlow(values, result1 => {
        ...
        getIdentityId(resolve, reject, selfServiceSettingsFlow);
    });
}

function getIdentityId(resolve, reject, selfServiceSettingsFlow){
