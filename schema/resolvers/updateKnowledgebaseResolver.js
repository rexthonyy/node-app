...
const updateUIColorForKnowledgeBase = require('../resolver-utils/updateUIColorForKnowledgeBase');
const recordHistory = require('../resolver-utils/recordHistoryResolver');
